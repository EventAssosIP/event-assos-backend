...
{
    public class RegistrationRepository : BaseRepository<Registration, Guid>, IRegistrationRepository
    {
        private readonly EventAssosContext _context;

        public RegistrationRepository(EventAssosContext context) : base(context)
        {
            _context = context;
        }
